    ...
    <section class=" ">
      <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div class="flex flex-col items-center max-w-sm mx-auto text-center">
          <p class="p-3 text-sm font-medium text-blue-600 rounded-full bg-blue-50 dark:bg-gray-800">
            <svg
          ...
          <h1 class="mt-3 text-2xl font-semibold text-gray-200 dark:text-white md:text-3xl">
            Page not found
          </h1>
